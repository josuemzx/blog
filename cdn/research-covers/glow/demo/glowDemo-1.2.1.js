...
// edits S3 urls from original
// edits DOMAIN

const DELTA_TIME = 1.0 / 45.0; // Default, 45 FPS.

const S3_PREFIX =
  "https://cdn.openai.com/research-covers/glow/";
const IMAGE_SRC_PREFIX =
  "https://cdn.openai.com/research-covers/glow/demo/media";
...
const DOMAIN = "https://glow.openai.com"; // https://glow.alpha.openai.org";
